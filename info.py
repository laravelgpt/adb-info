...
class DeviceInfoApp:
    ...
    def check_environment(self):
        ...
        try:
            ...
            if messagebox.askyesno("Missing Dependencies", 
                                 "ADB/Fastboot not found. Install automatically?"):
    ...
    def install_adb_automatically(self):
        """Install ADB and Fastboot automatically"""
        try:
            ...
            install_path = {
                "windows": os.path.join(os.environ['C'], 'Android', 'platform-tools'),
            ...
            messagebox.showinfo("Success", "ADB/Fastboot installed successfully")
            self.refresh_devices()
